...
describe('createStore', () => {
  ...
  it('does not allow getState() from within a reducer', () => {
    ...
    expect(() => store.dispatch(getStateInMiddle(store.getState.bind(store)))).toThrow(/You may not call store.getState()/);
  });

  it('does not allow subscribe() from within a reducer', () => {
    const store = createStore(reducers.subscribeInTheMiddleOfReducer);

    expect(() => store.dispatch(subscribeInMiddle(store.subscribe.bind(store, () => {})))).toThrow(/You may not call store.subscribe()/);
  });
  ...
  it('does not allow unsubscribe from subscribe() from within a reducer', () => {
    ...
    expect(() => store.dispatch(unsubscribeInMiddle(unsubscribe.bind(store)))).toThrow(/You may not unsubscribe from a store/);
  });
  ...
  it('throws if enhancer is neither undefined nor a function', () => {
    ...
    expect(() => createStore(reducers.todos, undefined, undefined)).not.toThrow();
